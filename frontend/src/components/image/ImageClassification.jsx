        ...
        <div className="space-y-6">
                ...
                {image ? (
                    ...
                    <div className="text-center p-6">
                        <div className="flex flex-col items-center gap-4">
                            ...
                            <button className="mt-4 flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded-full hover:bg-primary/90 transition-colors">
            ...
            {prediction && (
                <div className="bg-muted rounded-lg p-4 border border-border">
                    <p className="text-sm font-mono text-muted-foreground overflow-x-auto">
